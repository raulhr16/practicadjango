...
Generated by 'djangocms' command using django CMS 4.1.4 and Django 4.2.
...
SECRET_KEY = 'django-insecure-1+rorag^w^m9du5fp$1fqpp$t-&0k1jlcx-u*-7b^f77m97hyh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "practicadjango", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
